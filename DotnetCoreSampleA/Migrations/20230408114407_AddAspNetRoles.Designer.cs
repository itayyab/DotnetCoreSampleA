...
namespace DotnetCoreSampleA.Migrations
{
    ...
    [Migration("20230408114407_AddAspNetRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Category", b =>
                {
                    b.Property<long>("Cat_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("Cat_id"), 1L, 1);
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Models.Cart", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("Cart_id"), 1L, 1);
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Models.CartDetails", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("CD_id"), 1L, 1);
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Models.Product", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("Pr_id"), 1L, 1);

                    b.Property<long>("CategoryForeignKey")
                        .HasColumnType("bigint");

                    b.Property<string>("Pr_Picture")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pr_desc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pr_name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long>("Pr_price")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DotnetCoreSampleA.Models.Product", b =>
                {
                    b.HasOne("DotnetCoreSampleA.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DotnetCoreSampleA.Models.ApplicationUser", null)
                        .WithMany()
